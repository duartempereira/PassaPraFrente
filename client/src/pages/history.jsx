  ...
  useEffect(() => {
    const fetchHistory = async () => {
      ...
      try {
        ...
        await fetchData(
          `${process.env.REACT_APP_API_URL}/api/transaction-sales/user`,
          "Compra",
          "Vendas"
        );
        await fetchData(
          `${process.env.REACT_APP_API_URL}/api/transaction-loans/user/user`,
          "Emprestimo",
          "Empréstimos"
        );
        await fetchData(
          `${process.env.REACT_APP_API_URL}/api/winner-giveaway/user`,
          "Sorteio",
          "Sorteios"
        );
